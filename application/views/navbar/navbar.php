				...
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse">
					...
					<span class="icon-bar"></span>
							...
							if($this->session->userdata('id_user')){ ?>
								<a class="navbar-brand" href="<?php echo base_url();?>home"><span>IHP </span>SYSTEM | Kantor Pos Bandung 40000</a>
								<ul class="user-menu">
  							...
  							<li><a href="<?php echo base_url();?>login/logout"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Logout</a></li>
								...
								<?php	}else{  ?>
									<a class="navbar-brand" href="<?php echo base_url();?>depan"><span>IHP </span>SYSTEM | Kantor Pos Bandung 40000</a>
									<ul class="user-menu">
										<li class="dropdown pull-right">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> <?php echo $this->session->userdata('name');?> <span class="caret"></span></a>
											<ul class="dropdown-menu" role="menu">
									<li><a href="<?php echo base_url();?>login"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Login</a></li>
						<?php	}							 ?>
