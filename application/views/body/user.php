						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="iddd" data-sortable="true">Nama</th>
							    	...
							    	<th data-field="notlp" data-sortable="true">No Telp.</th>
											<th data-field="idddd" data-sortable="true">Email</th>
                           ...
                           <?php $no = 0; foreach($datauser as $row) : $no++;?>
						     <tr>
						        <td data-field="no" width="10px"><?php echo $no;?></td>
						         ...
						         <td data-field="nsik"><?php echo $row->name;?></td>
						        <td data-field="jk"><?php echo $row->jk;?></td>
										<td data-field="notlp"><?php echo $row->notlp;?></td>
										<td data-field="idddd"><?php echo $row->email;?></td>
