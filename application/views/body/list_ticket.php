...
<a style="text-decoration:none">List Ticket </a></div>
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="iddds" data-sortable="true">Reported Name</th>
						        <!-- <th data-field="idddXs" data-sortable="true">Dept</th> -->
										<th data-field="iddd" data-sortable="true">Nopen</th>
						        <th data-field="idddd" data-sortable="true">Tanggal</th>
						        <th data-field="iddddd" data-sortable="true">Nama Kategori</th>
						        <th data-field="idddddd" data-sortable="true">Nama Sub Kategori</th>
						        <th data-field="iddddddd" data-sortable="true">Status</th>
										<?php if($this->session->userdata('level')=="ADMIN")
						        {?>
										<th data-field="idddddddd" data-sortable="true">Aksi</th>
										<?php  } ?>
						    </tr>
                            </thead>
                            <tbody>
                           <?php $no = 0; foreach($datalist_ticket as $row) : $no++;?>
						     <tr>
						        ...
						        <td data-field="iddsd"><?php echo $row->reported_name;?></td>
 										<td data-field="id"><?php echo $row->nopen;?></td>
						        ...
						        {?>
										<td>
<a data-toggle="modal"  title="Hapus Kontak" class="hapus btn btn-danger btn-xs" href="#modKonfirmasi" data-id="<?php echo $row->id_ticket;?>"><span class="glyphicon glyphicon-trash"></span></a>
</td>   <?php  } ?>
						    </tr>
						    <?php endforeach;?>
						    </tbody>
