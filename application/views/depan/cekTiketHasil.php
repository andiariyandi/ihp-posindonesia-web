                        ...
                        <div class="col-1">
                           <div id="wb_servicesCard1" style="display:flex;width:calc(100% - 20px);z-index:4;">
                             <div id="servicesCard1-card-body">
                                ...
                                <div id="servicesCard1-card-item1"><i class="fa fa-ticket"></i> - <?php echo $id_ticket;?>
                                <br><br><i class="fa fa-exclamation-triangle"></i> - <?php echo $nama_kategori;?>
                                 <br><br><i class="fa fa-exclamation-triangle"></i> - <?php echo $nama_sub_kategori;?>
                                  <br><br><i class="fa fa-address-book"></i> - <?php echo $reported_name;?>
                                    <br><br><i class="fa fa-map-marker"></i> - <?php echo $nama_nopen;?>

                                </div>
                                <div id="servicesCard1-card-item2">Data Tiket </div>
                            </div>
                           </div>
                           ...
                           <div id="wb_servicesCard2" style="display:flex;width:calc(100% - 20px);z-index:5;">
                              <div id="servicesCard2-card-body">
                                 ...
                                 <div id="servicesCard1-card-item1"><i class="fa fa-user"></i> - <?php echo $nama_teknisi;?>
                                 <br><br><i class="fa fa-calendar-o"></i> - DIBUAT : <?php echo $tanggal;?>
                                  <br><br><i class="fa fa-calendar-o"></i> - <?php if($tanggal_proses == "0000-00-00 00:00:00") { echo "BELUM DI PROSES"; }
                             else
                             {?>
                             DIPROSES : <?php echo $tanggal_proses;?>
                             <?php }?>
                                   <br><br><i class="fa fa-calendar-o"></i> - <?php if($tanggal_solved == "0000-00-00 00:00:00") {  } else {?>
                                     SELESAI : <span class="label label-primary"><?php echo $tanggal_solved;?></span></b>
                             <?php }?>
                                     <br><br>
                                     <div class="w3-light-grey w3-round-xlarge">
                                         <div class="w3-container w3-orange w3-round-xlarge" style="width:<?php echo $progress;?>%"><?php echo $progress;?>%</div> </div>
                                 </div>
                                 <div id="servicesCard2-card-item2">Progres Tiket</div>
                              </div>
                           </div>
                        </div>
                        <div class="col-2">
                           <div id="wb_servicesCard3" style="display:flex;width:calc(100% - 20px);z-index:6;">
                              <div id="servicesCard3-card-body">
                                 <div id="servicesCard3-card-item0"><i class="fa fa-line-chart"></i></div>
                                 <div id="servicesCard3-card-item1"> Riwayat Status Tiket
                                 </div>
                                 <div id="servicesCard3-card-item2">
                                   <table>
                                     <tr>
                                       <th>NO</th>
                                      <th>TANGGAL</th>
