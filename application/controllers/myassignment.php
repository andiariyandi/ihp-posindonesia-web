...
function __construct(){
 ...
 function ticket_detail($id)
 {
        ...
        $sql = "SELECT A.progress, A.status, A.reported_name, C.id_kategori, A.id_ticket, A.tanggal, A.nopen, B.nama_sub_kategori, C.nama_kategori
                FROM ticket A
                LEFT JOIN sub_kategori B ON B.id_sub_kategori = A.id_sub_kategori
                LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
        ...
        $data['reported'] = $row->reported_name;
