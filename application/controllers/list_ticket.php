...
function __construct(){
 ...
 function pilih_teknisi($id)
 {
        ...
        //end notification
                ...
                $sql = "SELECT A.nopen, A.reported_name, A.status, A.id_ticket, A.tanggal, B.nama_sub_kategori, C.nama_kategori
                                           FROM ticket A
                                           LEFT JOIN sub_kategori B ON B.id_sub_kategori = A.id_sub_kategori
                                           LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
 ...
 function view_progress_teknisi($id)
 {
        ...
        //end notification
                                ...
                                $sql = "SELECT A.nopen, A.reported_name, A.status, A.id_ticket, A.tanggal, A.progress, A.nopen, A.tanggal_proses, A.id_teknisi, D.name AS nama_teknisi, A.tanggal_solved, B.nama_sub_kategori, C.nama_kategori
                                                           FROM ticket A
                                                           LEFT JOIN sub_kategori B ON B.id_sub_kategori = A.id_sub_kategori
                                                           LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
