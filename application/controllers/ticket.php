  ...
  $data['reported_mail'] = $reported_mail;
 	...
 	if ($this->db->trans_status() === FALSE)
			...
			} else
			{
			    ...
			    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
			    <svg class='glyph stroked empty-message'><use xlink:href='#stroked-empty-message'></use></svg> Ticket Berhasil di Buat, Kode Ticket Anda : <b> $ticket </b>. Mohon dicatat!
			    </div>");
